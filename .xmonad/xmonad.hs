...
main = do
    ...
    xmproc0 <- spawnPipe "xmobar -x 0 /home/tbissell/.config/xmobar/xmobarrc0"
    xmproc1 <- spawnPipe "xmobar -x 1 /home/tbissell/.config/xmobar/xmobarrc1"
    ...
    xmonad $ ewmh desktopConfig
        ...
        --, workspaces         = withScreens 2 ["www","edit"]
        , borderWidth        = myBorderWidth
        , normalBorderColor  = "#292d3e"
        , focusedBorderColor = "#4770a6"
...
myKeys =
    ...
    -- applications
        ...
        , ("M-r", spawn "dmenu_run -fn 'UbuntuMono Nerd Font:size=10' -nb '#292d3e' -nf '#bbc5ff' -sb '#82AAFF' -sf '#292d3e' -p 'dmenu:'")
        , ("M-f", spawn (myTerminal ++ " -e vifm"))

    -- Layout control
        , ("M-C-<Space>", sendMessage (T.Toggle "float"))
        ...
        , ("M-<Right>", moveTo Next nonNSP)                                -- Go to next workspace
        , ("M-<Left>", moveTo Prev nonNSP)                           -- Go to previous workspace
...
tall       = renamed [Replace "tall"]     $ limitWindows 12 $ spacing 2 $ ResizableTall 1 (3/100) (1/2) []
